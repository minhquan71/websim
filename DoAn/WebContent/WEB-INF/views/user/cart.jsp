...
<style type="text/css">
body {
  background: url("./images/muahang.png") no-repeat center center fixed;
...
<body>
	<div style="text-align: center;">
		<h1 style="color: red;align-self: center;">Kính chào quý khách</h1>
		<form class="formContact" action="buy.htm" method="get">

			<h2 style="align-self: center; color: red;">Mua Hàng</h2>
